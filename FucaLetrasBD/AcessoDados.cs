...
namespace FucaLetrasBD
{
    public class AcessoDados
    {
        ...
        private SqlConnection CriarConexao()
        {
            ...
            dbConn.ConnectionString = @"Data Source=GABRIELFILLA-PC\CPTNMIKKI;Initial Catalog=fucaletrasbd;Integrated Security=True";
            return dbConn;
        }
        ...
        //Altera as informações da musica
        public void UpdateMusica(CommandType commandType, string nomeStoredProcedure)
        {
            try
            {
                // Criar conexão
        ...
        //Altera as informações da letra
        public void UpdateLetra(CommandType commandType, string nomeStoredProcedure)
        {
            try
            {
                // Criar conexão
